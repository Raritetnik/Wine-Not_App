...
Route::put('celliers/{vino_cellier}/details-bouteille/{bouteille_par_cellier}', [CellierController::class, 'deplacerBouteille'])->name('deplacer.bouteille')->middleware('auth');
