...
<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
  ...
  <form method="post" enctype="multipart/form-data" class="max-w-[560px] mx-auto">
    ...
    <div class="mb-4">
      ...
      <textarea class="w-full h-full items-center justify-center px-6 font-medium tracking-wide text-accent_wine transition duration-200 rounded border border-accent_wine focus:shadow-outline" id="description" name="description" type="text" placeholder="Ajouter un descriptif pour ce cellier">{{$cellier->description}}</textarea>
    </div>
