        ...
        <div class="w-full flex flex-col">
          ...
          <div class="mb-2 flex justify-between gap-3">
            <div class="w-1/2 mb-2">
              ...
              <input class="block w-full py-3 px-3 placeholder-section_title rounded-md border border-gray-300 focus:border-secondary focus:outline-none appearance-none {{ $errors->has('quantite') ? 'border-error' : '' }}" name="quantite" id="quantite" placeholder="Quantité de bouteilles" value="{{ old('quantite') }}" required>
              </input>
