...
<div class="container mx-auto py-8 px-8 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
       ...
       <div class="text-center w-full">
        <a  href="{{route('cellier.modifier', ['cellier' => $cellier->id])}}" class="inline-flex items-center justify-center space-x-2 py-3 px-4 bg-accent_wine hover:accent_wine-80 text-main font-bold ml-2 py-2 px-4 rounded focus:outline-none focus:shadow-outline">
        ...
        {{-- <a
          href="{{route('cellier.modifier', ['cellier' => $cellier->id])}}"
  ...
  <div class="py-4 mt-6">
    <div onclick="location.href=`{{route('cellier.afficher', $cellier->id)}}`">
    ...
    <div class="px-4 py-16 mx-auto flex justify-center sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-16 lg:px-8 lg:py-20">
      ...
      <div class="grid gap-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        <div class="overflow-hidden  duration-300 flex flex-col gap-3 items-center max-w-[315px] bg-white rounded-lg max-h-55 p-4">
              <a href="{{route('bouteille.show', $bouteille->idBouteille)}}" aria-label="Article"><img src="{{ $bouteille->imageSAQ }}" class="object-cover max-h-[350px] rounded" alt="vine-img" /></a>
              <div class="text-center flex flex-col gap-2.5">
                <span class="font-semibold text-section_title">Cellier</span>
                <a href="{{route('bouteille.show', $bouteille->idBouteille)}}" aria-label="Article" class="inline-block text-article_title">
