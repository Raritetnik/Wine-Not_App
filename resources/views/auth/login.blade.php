  ...
  <div class="min-h-[500px] container flex justify-center items-center ">
    <div class="bg-white rounded-lg overflow-hidden max-w-[400px] w-full">
      ...
      <div id="Header" class="flex flex-col items-center my-10">
        ...
        <small style="color: var(--color_text)">Entrez dans votre compte</small>
      </div>
      <div class="px-6 mb-5">
        <form method="POST" action="{{ route('login') }}">
          ...
          <footer class="flex flex-col items-center mb-10">
            <button type="submit" class="text-white py-2 w-full rounded-md mb-2" style="background-color: #67375C">Continuer</button>
            <small style="color: #909090">
              Nouveau ici?
              <a href="/register" style="color: #67375C">Créer un compte</a>
            </small>
          </footer>
        </form>
      </div>
